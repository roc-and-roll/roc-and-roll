...
export const propTypes = {
  ...
  height: deprecated(
    PropTypes.number,
    "Pass `height` in `options` prop instead."
  ),
  width: deprecated(
    PropTypes.number,
    "Pass `height` in `options` prop instead."
...
export const includingContainerProps = including(
  Object.keys(possibleStandardNames[TYPES.CONTAINER])
);
export const includingStageProps = including(Object.keys(propTypes));
export const includingCanvasProps = (key) =>
  !includingContainerProps(key) && !includingStageProps(key);

export const getCanvasProps = (props) =>
  filterByKey(props, includingCanvasProps);
export const getContainerProps = (props) =>
  filterByKey(props, includingContainerProps);
